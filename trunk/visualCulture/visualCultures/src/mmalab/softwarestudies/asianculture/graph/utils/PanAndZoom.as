package mmalab.softwarestudies.asianculture.graph.utils
{
	...
	public class PanAndZoom extends ChartElement
	{
		...
		[Embed("images/both.gif")]
		private var bothCursor:Class;
		
		public function PanAndZoom()
		{
			super();
			addEventListener(MouseEvent.RIGHT_MOUSE_DOWN,startPanAndZoom);
		...
		private function startPanAndZoom(e:MouseEvent):void
		{
			...
			systemManager.addEventListener(MouseEvent.RIGHT_MOUSE_UP,endPanAndZoom,true);                        
		...
		private function endPanAndZoom(e:MouseEvent):void
		{
			...
			systemManager.removeEventListener(MouseEvent.RIGHT_MOUSE_UP,endPanAndZoom,true);                        
			_dragTool= null;    
		}
